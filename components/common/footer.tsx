...
const Footer = () => {
	return (
		<footer className="border-border xs:flex-row xs:gap-1 flex h-12 w-full flex-col items-center justify-center border-t py-2 text-sm backdrop-blur-xl md:sticky md:bottom-0">
